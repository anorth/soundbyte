...
extern "C" {
  jstring Java_com_example_scom_core_Jni_stringFromJNI(JNIEnv* env, jobject thiz);
  void Java_com_example_scom_core_Jni_init(JNIEnv* env, jobject thiz,
      jint base, jint chipRate, jint channelSpacing, jint numChannels);
  void Java_com_example_scom_core_Jni_encodeMessage(JNIEnv *env, jobject thiz, jbyteArray payload,
      jobject forWaveform);
  jint Java_com_example_scom_core_Jni_decodeAudio(JNIEnv *env, jobject thiz, jobject buffer);
  jboolean Java_com_example_scom_core_Jni_messageAvailable(JNIEnv *env, jobject thiz);
  jint Java_com_example_scom_core_Jni_takeMessage(JNIEnv *env, jobject thiz, jbyteArray target);
}
...
jint Java_com_example_scom_core_Jni_decodeAudio(JNIEnv *env, jobject thiz, jobject waveform) {
